...
<%@ page
	import="com.flipkart.data.*,java.util.Iterator,java.util.HashMap,java.util.Map"%>
		...
		<div class="row">
			...
			<div class="col-sm-9 padding-right">
				<div class="features_items">
					<!--features_items-->
					<h2 class="title text-center">Flipkart Deal of the Day!!</h2>
					...
					<c:forEach var="productInfo"  items="${productmap.values()}" varStatus="theCount">
